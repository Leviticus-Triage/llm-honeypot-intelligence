...
rule Honeypot_ToolDownload {
    ...
    strings:
        ...
        $s1 = "scp -t /tmp/ltyu2gbpejb4dog81ohvxsrwvs" ascii nocase
        $s2 = "scp -t /usr/local/bin/ltyu2gbpejb4dog81ohvxsrwvs" ascii nocase
        $s3 = "scp -t /dev/shm/ltyu2gbpejb4dog81ohvxsrwvs" ascii nocase
        $s4 = "scp -t /bin/ltyu2gbpejb4dog81ohvxsrwvs" ascii nocase
        $s5 = "scp -t /var/tmp/ltyu2gbpejb4dog81ohvxsrwvs" ascii nocase
        $s6 = "scp -t /usr/bin/ltyu2gbpejb4dog81ohvxsrwvs" ascii nocase
        $s7 = "scp -t ~/ltyu2gbpejb4dog81ohvxsrwvs" ascii nocase
